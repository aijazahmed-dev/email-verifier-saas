...
from .views import emails_check, bulk_csv_check_view, download_bulk_results, verification_history
...
urlpatterns = [
    ...
    path('history/', verification_history, name='verification_history'),
]